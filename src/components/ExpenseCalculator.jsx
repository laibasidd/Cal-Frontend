...
const ExpenseCalculator = () => {
  ...
  const addExpense = async () => {
    ...
    try {
      await axios.post("https://calculator-back.vercel.app/api/expenses/add", {
        itemName,
        quantity,
        price,
      });
  ...
  const fetchExpenses = async () => {
    try {
      const response = await axios.get("https://calculator-back.vercel.app/api/expenses");
  ...
  const removeExpense = async (id) => {
    try {
      await axios.delete(`https://calculator-back.vercel.app/api/expenses/${id}`);
